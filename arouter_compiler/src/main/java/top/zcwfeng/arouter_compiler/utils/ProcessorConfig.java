...
public interface ProcessorConfig {
    String AROUTER_PACKAGE = "com.brins.arouter_annotation.ARouter";
    String OPTIONS = "moduleName";//目的是接收 每个module名称
    String APT_PACKAGE= "packageNameForAPT";//目的是接收 包名（APT 存放的包名）

    String PARAMETER_PACKAGE= "com.brins.arouter_annotation.Parameter";
    // String全类名
    ...
    // ARouter api 包名
    String AROUTER_API_PACKAGE = "com.brins.arouter_api";
